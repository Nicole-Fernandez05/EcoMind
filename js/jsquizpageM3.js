...
let userAnswers = [];
let timeLeft = 900; // 15 minutes in seconds for Module 3
let timerInterval; // Declare timer interval here for this module

// STORE ORIGINAL QUESTIONS AND ANSWERS FOR MODULE 3 - *USING YOUR PROVIDED QUESTIONS*
...
let questions = []; // This array will hold the current shuffled questions for Module 3
